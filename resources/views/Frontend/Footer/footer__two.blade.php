            ...
            <div class="row">
                <div class="footer__widget__wrapper">
                    <div class="rts__widget">
                        <a href="{{route('index')}}"><img src="{{asset('assets/images/logo/footer__two.svg')}}" alt="footer logo"></a>
                    ...
                    <div class="rts__widget">
                        ...
                        <ul>
                            <li><a href="tel:+2347047000608"><i class="flaticon-phone-flip"></i> +2347047000608</a></li>
