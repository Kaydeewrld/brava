...
@section('content')
            ...
            <div class="row g-5 sticky-wrap">
                <div class="col-xxl-8 col-xl-7">
                    <div class="room__details">
                        <span class="h4 price">₦75,000</span>
                        <h2 class="room__title">Deluxe Room</h2>
                        <div class="room__meta">
                            <span><i class="flaticon-construction"></i>35 sqm</span>
                            <span><i class="flaticon-user"></i>2 Person</span>
                        </div>
                        <p>
                          Step into refined comfort in our Deluxe Room, thoughtfully designed for guests seeking extra space and sophistication. This inviting retreat features modern décor, premium bedding, and a tranquil ambiance perfect for relaxation or productivity.
                            <br> <br>
                           Enjoy a restful night’s sleep, unwind with a complimentary beverage, or step onto your private balcony for a breath of fresh air.
                        </p>
                        ...
                        <p> The Deluxe Room is equipped with amenities to make your stay both memorable and effortless.
    ...
    <div class="advance__search__wrapper">
      ...
      <input type="hidden" name="room_type" id="room_type" value="Deluxe Room">
      <input type="hidden" name="base_price" id="base_price" value="75000">
        ...
        <div class="total__price">
            ...
            <span class="price h6 m-0" id="total-price">₦75,000</span>
        </div>
...
document.addEventListener('DOMContentLoaded', function() {
    const basePrice = parseInt(document.getElementById('base_price').value) || 75000;
