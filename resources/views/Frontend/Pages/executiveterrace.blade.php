...
@section('content')
            ...
            <div class="row justify-content-center">
                <div class="col-lg-8">
                    <div class="room__details__top">
                        <span class="h2 price">₦150,000</span>
                        <h1>Executive Terrace</h1>
                        ...
                        <div class="room__feature mb-20">
                            <div class="room__image__group row row-cols-md-2 row-cols-sm-1 mt-30 mb-50 gap-4 gap-md-0">
                                <div class="room__image__item">
                                    <img class="rounded-2" src="{{asset('assets/images/deluxe.jpeg')}}" alt="">
                                </div>
                                <div class="room__image__item">
                                    <img class="rounded-2" src="{{asset('assets/images/deluxe2.jpeg')}}" alt="">
                                </div>
                            </div>
    ...
    <div class="advance__search__wrapper">
      ...
      <input type="hidden" name="room_type" id="room_type" value="Executive Terrace">
      <input type="hidden" name="base_price" id="base_price" value="150000">
        ...
        <div class="total__price">
            ...
            <span class="price h6 m-0" id="total-price">₦150,000</span>
        </div>
            ...
            <div class="row g-30">
                ...
                <div class="col-lg-6 col-xl-4 col-md-6">
                    @php 
                        $thumb = "2.webp";
                        $price = "₦200,000";
                        $title = "Presidential Suite 1 Room";
                    @endphp
                    @include('Frontend.Components.room-card-two',compact('thumb','price','title'))
                </div>
                <div class="col-lg-6 col-xl-4 col-md-6">
                    @php 
                        $thumb = "3.webp";
                        $price = "₦250,000";
                        $title = "Presidential Suite 2 Room";
                    @endphp
                    @include('Frontend.Components.room-card-two',compact('thumb','price','title'))
                </div>
            </div>
...
document.addEventListener('DOMContentLoaded', function() {
    const basePrice = parseInt(document.getElementById('base_price').value) || 150000;
