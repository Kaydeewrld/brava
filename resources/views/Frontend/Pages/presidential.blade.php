...
@section('content')
            ...
            <div class="row justify-content-center">
                <div class="col-lg-8">
                    <div class="room__details__top">
                        <span class="h2 price">₦200,000</span>
                        <h1>Presidential Suite 1 Room</h1>
    ...
    <div class="advance__search__wrapper">
      ...
      <input type="hidden" name="room_type" id="room_type" value="Presidential Suite 1 Room">
      <input type="hidden" name="base_price" id="base_price" value="200000">
        ...
        <div class="total__price">
            ...
            <span class="price h6 m-0" id="total-price">₦200,000</span>
        </div>
...
document.addEventListener('DOMContentLoaded', function() {
    const basePrice = parseInt(document.getElementById('base_price').value) || 200000;
