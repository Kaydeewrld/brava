...
@section('content')
            ...
            <div class="row g-5 sticky-wrap">
                <div class="col-xxl-8 col-xl-7">
                    <div class="room__details">
                        <span class="h4 price">₦120,000</span>
                        ...
                        <p>
                          Upgrade your stay with our spacious Executive Room, where elegance meets elevated comfort. Thoughtfully designed with a touch of luxury, this room offers extra space, plush bedding, and stylish furnishings, creating an inviting atmosphere for both work and relaxation.
                            <br> <br>
    ...
    <div class="advance__search__wrapper">
      ...
      <input type="hidden" name="room_type" id="room_type" value="Executive Room">
      <input type="hidden" name="base_price" id="base_price" value="120000">
        ...
        <div class="total__price">
            ...
            <span class="price h6 m-0" id="total-price">₦120,000</span>
        </div>
...
document.addEventListener('DOMContentLoaded', function() {
    const basePrice = parseInt(document.getElementById('base_price').value) || 120000;
