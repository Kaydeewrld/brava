...
@section('content')
            ...
            <div class="row g-5 sticky-wrap">
                <div class="col-xxl-8 col-xl-7">
                    <div class="room__details">
                        <span class="h4 price">₦80,000</span>
                        <h2 class="room__title">Premium Room</h2>
                        <div class="room__meta">
                            <span><i class="flaticon-construction"></i>35 sqm</span>
                            <span><i class="flaticon-user"></i>5 Person</span>
                        </div>
                        <p>
                          Upgrade your stay with our spacious Premium Room, where elegance meets elevated comfort. Thoughtfully designed with a touch of luxury, this room offers extra space, plush bedding, and stylish furnishings, creating an inviting atmosphere for both work and relaxation.
                            <br> <br>
                          Unwind in the generous seating area, catch up on your favorite shows with smart in-room technology, or sip your morning coffee on a private balcony with serene views.
                        </p>
                        ...
                        <p> The Premium Room is equipped with amenities to make your stay both memorable and effortless.
    ...
    <div class="advance__search__wrapper">
      ...
      <input type="hidden" name="room_type" id="room_type" value="Premium Room">
      <input type="hidden" name="base_price" id="base_price" value="80000">
        ...
        <div class="total__price">
            ...
            <span class="price h6 m-0" id="total-price">₦80,000</span>
        </div>
...
document.addEventListener('DOMContentLoaded', function() {
    const basePrice = parseInt(document.getElementById('base_price').value) || 80000;
